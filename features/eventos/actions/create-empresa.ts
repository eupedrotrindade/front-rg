...
import { CreateEmpresaRequest, Empresa, UpdateEmpresaRequest } from '../types'
...
export const vincularEmpresaEvento = async (
  empresaId: string,
  eventoId: string,
): Promise<boolean> => {
  try {
...
export const desvincularEmpresaEvento = async (
  empresaId: string,
  eventoId: string,
): Promise<boolean> => {
  try {
