...
export const eventoSchema = z.object({
  ...
  setupStartDate: z.string().min(1, "Início da montagem obrigatório"),
  setupEndDate: z.string().min(1, "Fim da montagem obrigatório"),
  preparationStartDate: z.string().min(1, "Início da preparação obrigatório"),
  preparationEndDate: z.string().min(1, "Fim da preparação obrigatório"),
  finalizationStartDate: z.string().min(1, "Início da desmontagem obrigatório"),
  finalizationEndDate: z.string().min(1, "Fim da desmontagem obrigatório"),
