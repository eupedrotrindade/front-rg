...
import { Check, Clock, RotateCcw, MoreVertical, User } from 'lucide-react'
...
const ParticipantRow = React.memo<{
    ...
    if (!participant) {
        return (
            <div style={style} className="flex items-center px-6 py-4 border-b border-gray-100">
                <div className="text-gray-500">Carregando...</div>
            </div>
        )
    }

    const botaoTipo = getBotaoAcao(participant, data.currentSelectedDay, data.hasCheckIn, data.hasCheckOut)
    ...
    return (
        ...
        >
            <div className="grid grid-cols-6 gap-4 w-full items-center">
                ...
                <div className="col-span-1 hidden md:block">
                    <div className="space-y-1">
                        <p className="text-gray-600 text-sm uppercase">{participant.validatedBy || '-'}</p>
                ...
                {/* CPF */}
                <div className="col-span-1">
                    <p className="text-gray-600 text-sm font-mono uppercase">{participant.cpf}</p>
                </div>
...
const VirtualizedParticipantsTable: React.FC<VirtualizedParticipantsTableProps> = ({
    participants,
